...
import type { JobType as _JobType, Lead as _Lead, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async submitLead(arg0: string, arg1: string, arg2: string, arg3: string, arg4: JobType, arg5: string | null): Promise<Lead> {
        if (this.processError) {
            try {
                const result = await this.actor.submitLead(arg0, arg1, arg2, arg3, to_candid_JobType_n11(this._uploadFile, this._downloadFile, arg4), to_candid_opt_n13(this._uploadFile, this._downloadFile, arg5));
...
function from_candid_variant_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "repair" in value ? JobType.repair : "inspection" in value ? JobType.inspection : "emergency" in value ? JobType.emergency : "replacement" in value ? JobType.replacement : value;
}
